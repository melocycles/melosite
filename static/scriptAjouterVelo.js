...
function addBike(){
    ...
    const listeAttributes = ["benevole", "referent", "dateEntre", "origine", "etatVelo", "marque", "typeVelo", "tailleRoue", "tailleCadre", "bycode", "electrique", "prochaineAction", "valeur", "destinataireVelo", "descriptionPublic", "descriptionPrive"]
