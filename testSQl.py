...
if 1: # vélo pour le test
    ...
    bike3 = {'bycode': 'CD456', 'dateEntre': '2023-04-20', 'marque': 'SpeedyBike', 'typeVelo': 'Ville', 'tailleRoue': '27pouces', 'tailleCadre': 'L', 'photo1': b'image_blob_4', 'photo2': b'image_blob_5', 'photo3': b'image_blob_6', 'electrique': False, 'origine': 'trouvé', 'status': 'en stock', 'etatVelo': 'moyen', 'prochaineAction': 'à réparer', 'referent': 'Alice Smith', 'valeur': 500.0, 'destinataireVelo': '', 'descriptionPublic': 'Vélo de montagne électrique, besoin de réparations.', 'descriptionPrive': '', 'dateSortie': None, 'typeSortie': ''}
...
#potentialErrorReturn = sqlCRUD.addBike()
